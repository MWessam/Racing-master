...
namespace NovaSamples.UIControls
{
    ...
    public static class TextPositionExtensions
    {
        ...
        /// preference.
        /// </summary>
        static private readonly char[] wordSeparators = { ' ', '.', ',', '\t', '\r', '\n' };
        ...
        /// </remarks>
        static private TextPosition MoveUntilValid(this TextPosition pos, int direction)
        {
            if (pos.IsValid)
            {
                // Already valid
        ...
        /// </summary>
        static private TextPosition MoveOneVisiblePosition(this TextPosition pos, int direction)
        {
        ...
        /// </summary>
        static private int GetVisibleDifference(TextPosition rightPosition, TextPosition leftPosition)
        {
        ...
        /// </summary>
        static private bool TryGetNextValid(this TextPosition pos, int direction, out TextPosition outPos)
        {
            outPos = pos;
            do
            {
        ...
        /// </summary>
        static private TextPosition MoveUnsafe(this TextPosition pos, int direction)
        {
            if (direction > 0)
            {
                // Moving right
