...
namespace NovaSamples.DummyScripts
{
    ...
    {
        static private readonly Color Magenta = new Color(1, 0.2f, 1);
        static private readonly Color Orange = new Color(1, 0.6f, 0);
        static private readonly Color Yellow = new Color(0.87f, 1,0.2f);
        static private readonly Color Green = new Color(0, 1, 0.33f);
        static private readonly Color Cyan = new Color(0, 1, 1);
        static private readonly Color Blue = new Color(0, 0.33f, 1);

        static private readonly float XRotation = Mathf.Atan(1 / Mathf.Sqrt(2)) * Mathf.Rad2Deg;
        static private readonly float ZRotation = 45;
        ...
        [NonSerialized]
        private readonly List<List<Matrix4x4>> matrices = new List<List<Matrix4x4>>();
