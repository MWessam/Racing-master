...
namespace NovaSamples.UIControls.Editor
{
    ...
    {
        static private readonly GUIContent CreateAnimationsLabel = EditorGUIUtility.TrTextContent("Create Animations", "Creates all required animation assets and adds an Animator component if it doesn't already exist.");
        ...
        static private readonly string[] ColorChangeFields = new string[] { TransitionTargetName, DefaultColorName, HoveredColorName, PressedColorName, TransitionDurationName };
        static private readonly string[] SpriteSwapFields = new string[] { TransitionTargetName, SpritesName };
        static private readonly string[] AnimationFields = new string[] { AnimationsName };

        static private readonly HashSet<string> BaseFields = new HashSet<string>()
        {
        ...
        static private Rect DrawAllChildClassFields(Rect position, SerializedProperty property)
        {
        ...
        static private Rect DrawFields(Rect position, SerializedProperty property, string[] relativePropertyNames)
        {
        ...
        static private Rect DrawProperty(Rect position, SerializedProperty property, GUIContent label = null)
        {
        ...
        static private float GetFieldHeight(SerializedProperty property, string relativePropertyName)
        {
            SerializedProperty relativeProperty = property.FindPropertyRelative(relativePropertyName);
        ...
        static private int GetChildPropertyCount(SerializedProperty property, string relativePropertyName)
        {
            SerializedProperty relativeProperty = property.FindPropertyRelative(relativePropertyName);
...
#if PACKAGE_ANIMATION
        static private void DrawCreateAnimationsButton(ItemView itemView)
        {
        ...
        static private AnimatorController CreateAnimatorControllerAsset(AnimationStates animations, ItemView target)
        {
            if (target == null)
            {
                return null;
        ...
        static private AnimationClip CreateAnimationForController(AnimatorController controller, string animationName)
        {
        ...
        static private string GetSaveControllerPath(MonoBehaviour target)
        {
