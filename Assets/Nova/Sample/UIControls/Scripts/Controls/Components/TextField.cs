...
namespace NovaSamples.UIControls
{
    public class TextField : MonoBehaviour
    {
        ...
        /// </summary>
        private readonly List<UIBlock2D> highlightPool = new List<UIBlock2D>();
        /// <summary>
        /// The currently active highlights
        /// </summary>
        private readonly List<UIBlock2D> activeHighlights = new List<UIBlock2D>();
        ...
        {
            public readonly UIBlock2D Target;
