...
public class RCCP_AI : MonoBehaviour {
    ...
    private void OnEnable() {
        ...
        if (CarController)
            ...
            {
                var addons = CarController.gameObject.AddComponent<RCCP_OtherAddons>();
                addons.AI = this;
            }
        else
            enabled = false;
            ...
            case NavigationMode.FollowWaypoints:
                ...
                if (!reversingNow) {
                    ...
                    // if (limitSpeed)
                        ...
                        if (CarController.speed >= maximumSpeed)
                        {
                            throttleInput = 0.0f;
                        }
                        else
                    ...
                    if (CarController.speed > maximumSpeed / 2) {
    ...
    private void CheckReset() {
        ...
        if (resetTime >= 10 || Mathf.Abs(CarController.speed) >= 25) {
