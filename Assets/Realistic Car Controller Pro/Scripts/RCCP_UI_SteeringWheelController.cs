...
public class RCCP_UI_SteeringWheelController : MonoBehaviour {
    ...
    private void SteeringWheelEventsInit() {
        ...
        EventTrigger.TriggerEvent a = new EventTrigger.TriggerEvent();
        a.AddListener(data => {
            PointerEventData evData = (PointerEventData)data;
            data.Use();
        ...
        EventTrigger.TriggerEvent b = new EventTrigger.TriggerEvent();
        b.AddListener(data => {
            PointerEventData evData = (PointerEventData)data;
            data.Use();
            steeringWheelTouchPos = evData.position;
        ...
        EventTrigger.TriggerEvent c = new EventTrigger.TriggerEvent();
        c.AddListener(data => {
            steeringWheelPressed = false;
        });
